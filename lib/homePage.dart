            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                image: const DecorationImage(
                                                    image: NetworkImage(
                                                        "https://pub.dev/static/hash-aps7rpf8/img/ff-banner-mobile-2x.png"),
                                                    fit: BoxFit.cover),
                  ...
                  Center(child: Text("\nEmergency Help\n       Needed ?",style: TextStyle(fontSize: 35,color: Colors.white),)),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Center(
          child: _isZoomed?Column(
            children: [
              if(mode == 0)if(_showText)Column(
                mainAxisAlignment: MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Text("SOS",style: TextStyle(fontSize: 100,fontWeight: FontWeight.w800,color: Colors.red),),
                  Text("IS",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w500),),
                  Text("Activated",style: TextStyle(fontSize: 60,fontWeight: FontWeight.w800,color: Colors.greenAccent),),
                  CountdownFormatted(
                    duration: Duration(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text("Activate",style: TextStyle(fontSize: 25),),
                          ),
                        ),
                      ],
                    ),
